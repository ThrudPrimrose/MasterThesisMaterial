...
\begin{tikzpicture}
    ...
    %\draw [thick,draw=BlueViolet!40!black] (.8+0.2,1.0) rectangle (1.0+0.2,1.2);
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (.8+0.2,1.0) rectangle (1.0+0.2,1.2);
    %\draw [step=0.4/2, very thin, color=gray] (.8+0.2,1.0) grid (1.0+0.2,1.2);
    ...
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+2*0.2,1.6+2*0.2) rectangle (2+0.2+2*0.2,1.6+0.2+2*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+0*0.2,1.6+1*0.2) rectangle (2+0.2+0*0.2,1.6+0.2+1*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+3*0.2,1.6+2*0.2) rectangle (2+0.2+3*0.2,1.6+0.2+2*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+1*0.2,1.6+3*0.2) rectangle (2+0.2+1*0.2,1.6+0.2+3*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+1*0.2,1.6+0*0.2) rectangle (2+0.2+1*0.2,1.6+0.2+0*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+3*0.2,1.6+3*0.2) rectangle (2+0.2+3*0.2,1.6+0.2+3*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+0*0.2,1.6+2*0.2) rectangle (2+0.2+0*0.2,1.6+0.2+2*0.2);
    \filldraw [fill=Cerulean!10!white,draw=Cerulean!40!black] (2+2*0.2,1.6+1*0.2) rectangle (2+0.2+2*0.2,1.6+0.2+1*0.2);
    \draw [step=0.4/2, very thin, color=gray] (2, 1.6) grid (2.8,2.4);
    
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2+2*0.2,1.6+2*0.2) rectangle (2+0.2+2*0.2,1.6+0.2+2*0.2);
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2+3*0.2,1.6+2*0.2) rectangle (2+0.2+3*0.2,1.6+0.2+2*0.2);
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2+0*0.2,1.6+2*0.2) rectangle (2+0.2+0*0.2,1.6+0.2+2*0.2);
    ...
    % Code Col-wise, iter 1
    %\draw [thick,draw=BlueViolet!40!black] (2,2.2) rectangle (2.2,2.4);
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2,2.2) rectangle (2.2,2.4);
    %\draw [step=0.4/2, very thin, color=gray] (2, 2.2) grid (2.2,2.4);
    ...
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2+2*0.2,0+5*0.2) rectangle (2+0.2+2*0.2,0+0.2+5*0.2);
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2+3*0.2,0+5*0.2) rectangle (2+0.2+3*0.2,0+0.2+5*0.2);
    %\filldraw [fill=BlueViolet!10!white,draw=BlueViolet!40!black] (2+0*0.2,0+5*0.2) rectangle (2+0.2+0*0.2,0+0.2+5*0.2);
