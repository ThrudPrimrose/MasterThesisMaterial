...
__launch_bounds__(32)
 kernel_sloopOverGEMM_NT_NT_NT__d13_49_d13_14_d49_14__alpha_1_0_beta_0_0_p_p_p__f1a7746(const float * const * C, int C_extraOffset, const float * const * D, int D_extraOffset, float ** X, int X_extraOffset, unsigned numElements, unsigned* flags) {
  ...
  if (batchID < numElements) {
    ...
    //('gemm', {'descr': Description(  result=TensorDescription(  name=X,	  memoryLayout=DenseMemoryLayout(shape=(13, 14), bbox=BoundingBox(Range(0, 13), Range(0, 14)), stride=(1, 13), align=<yateto.arch.Architecture object at 0x7f3bda31a990>),	  eqspp=dense(shape=(13, 14), size=182, ndim=2),	  is_compute_constant=False,	  is_temporary=False),	  leftTerm=TensorDescription(  name=C,	  memoryLayout=DenseMemoryLayout(shape=(13, 49), bbox=BoundingBox(Range(0, 13), Range(0, 49)), stride=(1, 13), align=<yateto.arch.Architecture object at 0x7f3bda31a990>),	  eqspp=dense(shape=(13, 49), size=637, ndim=2),	  is_compute_constant=False,	  is_temporary=False),	  rightTerm=TensorDescription(  name=D,	  memoryLayout=DenseMemoryLayout(shape=(49, 14), bbox=BoundingBox(Range(0, 49), Range(0, 14)), stride=(1, 49), align=<yateto.arch.Architecture object at 0x7f3bda31a990>),	  eqspp=dense(shape=(49, 14), size=686, ndim=2),	  is_compute_constant=False,	  is_temporary=False),	  transA=False,	  transB=False,	  alpha=1.0,	  beta=0.0,	  prefetchName=None,	  isACsc=False,	  isBCsc=False,	  alignedA=False,	  alignedC=False,	  mnk=(Range(0, 13), Range(0, 14), Range(0, 49))), 'matrix_a': DenseMatrix{name = C, num. rows = 13, num. columns = 49, leading dimension = 13, direction = DataFlowDirection.SOURCE, bbox = [0, 0, 13, 49]}, 'matrix_b': DenseMatrix{name = D, num. rows = 49, num. columns = 14, leading dimension = 49, direction = DataFlowDirection.SOURCE, bbox = [0, 0, 49, 14]}, 'matrix_c': DenseMatrix{name = X, num. rows = 13, num. columns = 14, leading dimension = 13, direction = DataFlowDirection.SINK, bbox = [0, 0, 13, 14]}, 'args': ['C, extraOffset_C', 'D, extraOffset_D', 'X, extraOffset_X', 'numElements', 'flags', 'streamPtr']})
        ...
        __shared__  __align__(8) float totalShrMem[1323];
        ...
        if (threadIdx.x < 13) {
          ...
          #pragma unroll
          for (int k = 0; k < 49; ++k) {
            value = shrRegion0[threadIdx.x + k * 13];
        
            #pragma unroll
            for (int n = 0; n < 14; ++n) {
              reg0[n] += value * shrRegion1[k + 49 * n];
            }
          }
        }
        if (threadIdx.x < 13) {
...
void sloopOverGEMM_NT_NT_NT__d13_49_d13_14_d49_14__alpha_1_0_beta_0_0_p_p_p__f1a7746(const float * const * C, int C_extraOffset, const float * const * D, int D_extraOffset, float ** X, int X_extraOffset, unsigned numElements, unsigned* flags, void* streamPtr) {
  dim3 block(32, 1, 1);
  dim3 grid((numElements + 1 - 1) / 1, 1, 1);
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_sloopOverGEMM_NT_NT_NT__d13_49_d13_14_d49_14__alpha_1_0_beta_0_0_p_p_p__f1a7746<<<grid,block,0,stream>>>(C, C_extraOffset, D, D_extraOffset, X, X_extraOffset, numElements, flags);
  CHECK_ERR;
}
...
__launch_bounds__(192)
 kernel_sloopOverGEMM_NT_NT_NT__d182_8_d182_25_d8_25__alpha_1_0_beta_1_0_p_p_p__6333b40(float ** A, int A_extraOffset, const float * const * E, int E_extraOffset, const float * const * F, int F_extraOffset, unsigned numElements, unsigned* flags) {
  unsigned batchID = (threadIdx.y + blockDim.y * blockIdx.x);
  if (batchID < numElements) {
    bool isFlagsProvided = (flags != nullptr);
    bool allowed = isFlagsProvided ? static_cast<bool>(flags[batchID]) : true;
    ...
    //('gemm', {'descr': Description(  result=TensorDescription(  name=A,	  memoryLayout=DenseMemoryLayout(shape=(182, 25), bbox=BoundingBox(Range(0, 182), Range(0, 25)), stride=(1, 182), align=<yateto.arch.Architecture object at 0x7f3bda2f5650>),	  eqspp=dense(shape=(182, 25), size=4550, ndim=2),	  is_compute_constant=False,	  is_temporary=False),	  leftTerm=TensorDescription(  name=E,	  memoryLayout=DenseMemoryLayout(shape=(182, 8), bbox=BoundingBox(Range(0, 182), Range(0, 8)), stride=(1, 182), align=<yateto.arch.Architecture object at 0x7f3bda2f5650>),	  eqspp=dense(shape=(182, 8), size=1456, ndim=2),	  is_compute_constant=False,	  is_temporary=False),	  rightTerm=TensorDescription(  name=F,	  memoryLayout=DenseMemoryLayout(shape=(8, 25), bbox=BoundingBox(Range(0, 8), Range(0, 25)), stride=(1, 8), align=<yateto.arch.Architecture object at 0x7f3bda2f5650>),	  eqspp=dense(shape=(8, 25), size=200, ndim=2),	  is_compute_constant=False,	  is_temporary=False),	  transA=False,	  transB=False,	  alpha=1.0,	  beta=1.0,	  prefetchName=None,	  isACsc=False,	  isBCsc=False,	  alignedA=False,	  alignedC=False,	  mnk=(Range(0, 182), Range(0, 25), Range(0, 8))), 'matrix_a': DenseMatrix{name = E, num. rows = 182, num. columns = 8, leading dimension = 182, direction = DataFlowDirection.SOURCE, bbox = [0, 0, 182, 8]}, 'matrix_b': DenseMatrix{name = F, num. rows = 8, num. columns = 25, leading dimension = 8, direction = DataFlowDirection.SOURCE, bbox = [0, 0, 8, 25]}, 'matrix_c': DenseMatrix{name = A, num. rows = 182, num. columns = 25, leading dimension = 182, direction = DataFlowDirection.SINK, bbox = [0, 0, 182, 25]}, 'args': ['E, extraOffset_E', 'F, extraOffset_F', 'A, extraOffset_A', 'numElements', 'flags', 'streamPtr']})
        ...
        __shared__  __align__(8) float totalShrMem[1656 + 25*182];
        float * localShrMem0 = &totalShrMem[(1656 + 25*182)* threadIdx.y];
        ...
        // using ExtendedPatchLoader
        {
          #pragma unroll
          for (int i = 0; i < 7; ++i) {
            shrRegion0[threadIdx.x + i * 192] = glb_E[threadIdx.x + i * 192];
          }
          if (threadIdx.x < 112) {
            shrRegion0[threadIdx.x + 1344] = glb_E[threadIdx.x + 1344];
          }
        }
        
        float* shrRegion1 = &localShrMem0[1456];
        // using ExtendedPatchLoader
        {
          shrRegion1[threadIdx.x + 0] = glb_F[threadIdx.x + 0];
          if (threadIdx.x < 8) {
            shrRegion1[threadIdx.x + 192] = glb_F[threadIdx.x + 192];
          }
        }

        float* shrRegion2 = &localShrMem0[1656];
        // using ExtendedPatchLoader
        {
          #pragma unroll
          for (int i = 0; i < 23; ++i) {
            shrRegion2[threadIdx.x + i*192] = glb_A[threadIdx.x + i*192];
          }
          
          if (threadIdx.x < 134) {
            shrRegion2[threadIdx.x + 23*192] = glb_A[threadIdx.x + 23*192];
          }
        }
        ...
        if (threadIdx.x < 182) {
          ...
          #pragma unroll
          for (int k = 0; k < 8; ++k) {
            value = shrRegion0[threadIdx.x + k * 182];
        
            #pragma unroll
            for (int n = 0; n < 25; ++n) {
              reg0[n] += value * shrRegion1[k + 8 * n];
            }
          }
        }
        if (threadIdx.x < 182) {
          #pragma unroll
          for (int n = 0; n < 25; ++n) {
            glb_A[threadIdx.x + 182 * n] = reg0[n] + shrRegion2[threadIdx.x + 182 * n];
          }
        }
...
void sloopOverGEMM_NT_NT_NT__d182_8_d182_25_d8_25__alpha_1_0_beta_1_0_p_p_p__6333b40(float ** A, int A_extraOffset, const float * const * E, int E_extraOffset, const float * const * F, int F_extraOffset, unsigned numElements, unsigned* flags, void* streamPtr) {
  dim3 block(192, 1, 1);
  dim3 grid((numElements + 1 - 1) / 1, 1, 1);
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_sloopOverGEMM_NT_NT_NT__d182_8_d182_25_d8_25__alpha_1_0_beta_1_0_p_p_p__6333b40<<<grid,block,0,stream>>>(A, A_extraOffset, E, E_extraOffset, F, F_extraOffset, numElements, flags);
  CHECK_ERR;
}
...
__launch_bounds__(352)
 kernel_sproduct_NT_NT_NT__d25_d13_14_25_d13_14__alpha_1_0_p_p_p__dcb271f(float ** A, int A_extraOffset, const float * const * B, int B_extraOffset, const float * const * X, int X_extraOffset, unsigned numElements, unsigned* flags) {
  unsigned batchID = (threadIdx.y + blockDim.y * blockIdx.x);
  if (batchID < numElements) {
    bool isFlagsProvided = (flags != nullptr);
    bool allowed = isFlagsProvided ? static_cast<bool>(flags[batchID]) : true;
    if (allowed) {
      {
        ...
        Description(
        	alpha: 1.0
        	add: True
        	result: IndexedTensorDescription(name=A, indices=kpm, memoryLayout=DenseMemoryLayout(shape=(13, 14, 25), bbox=BoundingBox(Range(0, 13), Range(0, 14), Range(0, 25)), stride=(1, 13, 182), align=<yateto.arch.Architecture object at 0x7f3bda31b910>), eqspp=dense(shape=(13, 14, 25), size=4550, ndim=3), is_compute_constant=False, is_temporary=False)
        	leftTerm: IndexedTensorDescription(name=B, indices=m, memoryLayout=DenseMemoryLayout(shape=(25,), bbox=BoundingBox(Range(0, 25)), stride=(1,), align=<yateto.arch.Architecture object at 0x7f3bda31b910>), eqspp=dense(shape=(25,), size=25, ndim=1), is_compute_constant=False, is_temporary=False)
        	rightTerm: IndexedTensorDescription(name=X, indices=kp, memoryLayout=DenseMemoryLayout(shape=(13, 14), bbox=BoundingBox(Range(0, 13), Range(0, 14)), stride=(1, 13), align=<yateto.arch.Architecture object at 0x7f3bda31b910>), eqspp=dense(shape=(13, 14), size=182, ndim=2), is_compute_constant=False, is_temporary=False)
        	isACsc: False
        	isBCsc: False
...
void sproduct_NT_NT_NT__d25_d13_14_25_d13_14__alpha_1_0_p_p_p__dcb271f(float ** A, int A_extraOffset, const float * const * B, int B_extraOffset, const float * const * X, int X_extraOffset, unsigned numElements, unsigned* flags, void* streamPtr) {
  dim3 block(352, 1, 1);
  dim3 grid((numElements + 1 - 1) / 1, 1, 1);
  cudaStream_t stream = (streamPtr != nullptr) ? static_cast<cudaStream_t>(streamPtr) : 0;
  kernel_sproduct_NT_NT_NT__d25_d13_14_25_d13_14__alpha_1_0_p_p_p__dcb271f<<<grid,block,0,stream>>>(A, A_extraOffset, B, B_extraOffset, X, X_extraOffset, numElements, flags);
  CHECK_ERR;
}
...
int main(){
  ...
  sloopOverGEMM_NT_NT_NT__d13_49_d13_14_d49_14__alpha_1_0_beta_0_0_p_p_p__f1a7746(C_dev_begins_dev, 0, D_dev_begins_dev, 0, X_dev_begins_dev, 0, num_els, nullptr, nullptr); CHECK_ERR;
  cudaDeviceSynchronize(); CHECK_ERR;
  cudaMemcpy((void *)X_dev, (void *)X, sizeof(float) * 182 * num_els, cudaMemcpyHostToDevice); CHECK_ERR;
  ...
  sloopOverGEMM_NT_NT_NT__d182_8_d182_25_d8_25__alpha_1_0_beta_1_0_p_p_p__6333b40(A_dev_begins_dev, 0, E_dev_begins_dev, 0, F_dev_begins_dev, 0, num_els, nullptr, nullptr); CHECK_ERR;
  ...
  sproduct_NT_NT_NT__d25_d13_14_25_d13_14__alpha_1_0_p_p_p__dcb271f(A_dev_begins_dev, 0, B_dev_begins_dev, 0, X_dev_begins_dev, 0, num_els, nullptr, nullptr); CHECK_ERR;
